 ...
 * 
 * List<SimpleGrantedAuthority> authority = new ArrayList<>(); authority.add(new
 * SimpleGrantedAuthority("ROLE_"+retrievedUser.getRole())); User user = new
 * User(retrievedUser.getEmailId(),passwordEncoder().encode(retrievedUser.
 * getPassword()), authority);
 * 
 * return user;
 * 
 * 
 * String pass = passwordEncoder().encode("pass"); return new User("foo",pass,
 * new ArrayList<>());
 * 
 * }
 * 
